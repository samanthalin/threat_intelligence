...
var csCookies = Cookies.noConflict();
        var
          ...
          cookieScriptDomain = "",
          cookieScriptReadMore = "/tw/zh/privacy_policy.shtml",
          cookieId = "d6b338e32e131051fbbcd1e9941bcaef",
          cookieScriptDebug = 0,
          cookieScriptShowBadge=true,
          cookieScriptCurrentUrl = window.location.href,
          cookieScriptTitle = '<h4 id="cookiescript_header">網站Cookies的使用</h4>',
          cookieScriptDesc = "我們與第三方合作，在我們的網站上放置cookies。 這些Cookies有助於提供使用者客製化內容、投放廣告和分析網站流量。以進而提供您更好的網頁瀏覽體驗。藉由點選“同意”或繼續瀏覽網頁的方式，您同意我們使用網站Cookies。之後，您仍可以管理是否要繼續使用網站與第三方合作的Cookies。<br \/>",
          cookieScriptAccept = '同意',
          cookieScriptMore = '閱讀更多',
          cookieScriptCopyrights = '同意',
